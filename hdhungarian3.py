...
with tab1:
    ...
    st.sidebar.write(
        f"Nilai :orange[Min]: :orange[**{df_final['age'].min()}**], Nilai :red[Max]: :red[**{df_final['age'].max()}**]"
    )
    st.sidebar.write("")

    sex_sb = st.sidebar.selectbox(
        label=":blue[**Jenis Kelamin**]", options=["Pria", "Wanita"]
    )
    st.sidebar.write("")
    st.sidebar.write("")
    if sex_sb == "Pria":
    ...
    trestbps = st.sidebar.number_input(
        label=":blue[**Tekanan Darah saat Istirahat** (dalam mm Hg saat pertama masuk ke RS)]",
    ...
    chol = st.sidebar.number_input(
        label=":blue[**Jumlah Kolesterol dalam Darah** (dalam mg/dl)]",
    ...
    restecg_sb = st.sidebar.selectbox(
        label=":blue[**Hasil EKG Istirahat**]",
        options=[
            "Normal",
    ...
    thalach = st.sidebar.number_input(
        label=":blue[**Denyut Jantung Maksimum**]",
    ...
    exang_sb = st.sidebar.selectbox(
        label=":blue[**Nyeri Dada saat Beraktivitas Fisik?**]",
        options=["Tidak", "Iya"],
    )
    st.sidebar.write("")
    st.sidebar.write("")
    ...
    oldpeak = st.sidebar.number_input(
        label=":blue[**Penurunan Segmen ST pada EKG saat Latihan Fisik**]",
